...
const paths = [
  {
    ...
    avatarPath: '/assets/Cheetah Day Trader.png',
    startTier: 0.5,
    color: 'yellow',
  ...
  },
  {
    ...
    avatarPath: '/assets/Capybara_Foliage_Refined.png',
    startTier: 0,
    color: 'emerald',
  ...
  },
  {
    ...
    avatarPath: '/assets/Tucan_Female_Closeup.png',
    startTier: 3,
    color: 'amber',
  ...
  },
  {
    ...
    avatarPath: '/assets/orangutan_old_money.png',
    startTier: 5,
    color: 'violet',
