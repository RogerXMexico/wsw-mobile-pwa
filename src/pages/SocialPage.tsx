  ...
  return (
    <div className="px-4 pb-24" style={{ paddingTop: 'calc(env(safe-area-inset-top, 0px) + 24px)' }}>
      <div className="mb-6">
        ...
        <p className="text-slate-400 text-sm mt-1">Live trades, competitions & gamification</p>
      </div>
      ...
      <div className="mt-6 text-center">
        <p className="text-slate-600 text-xs">Social features are rolling out — stay tuned 🐒</p>
      </div>
    </div>
  );
}
